...
export async function getCurrentUser() {
    ...
    try {
        ...
        // Database connection failed — gracefully degrade to unauthenticated
        // state so the app renders instead of crashing (500 errors).
        // The user can still browse public pages; protected actions will redirect.
        console.error("Database connection failed, treating as unauthenticated:", error.message || error);
        return null;
    }
}
